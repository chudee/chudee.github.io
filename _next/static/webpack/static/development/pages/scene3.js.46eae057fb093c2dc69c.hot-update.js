...
var Scene3 = function Scene3() {
  ...
  return __jsx("main", {
    ...
    onMouseOver: function onMouseOver(e) {
      var target = e.target;
      console.log(target.style); // target.classList.add('open open--right');
    },
    onMouseLeave: function onMouseLeave(e) {
      var target = e.target;
      target.classList.remove('open');
...
//# sourceMappingURL=scene3.js.46eae057fb093c2dc69c.hot-update.js.map